...
TEST_MESSAGES = [
    {
        "task_id": "test_user_1",
        "prompt": "Купить молоко, хлеб и яйца в магазине до вечера",
        "tags": ["покупки", "продукты"],
        "categories": ["личное", "работа"]
    },
    {
        "task_id": "test_user_1",
        "prompt": "Позвонить врачу и записаться на прием в следующий вторник в 10:00",
        "tags": ["здоровье", "звонки"],
        "categories": ["личное"]
    },
    {
        "task_id": "test_user_2",
        "prompt": "Подготовить презентацию по проекту до пятницы, включить графики и статистику",
        "tags": ["работа", "презентация", "проект"],
        "categories": ["работа", "личное"]
    },
    {
        "task_id": "test_user_2",
        "prompt": "Отправить отчет начальнику о проделанной работе за неделю",
        "tags": ["работа", "отчет"],
        "categories": ["работа"]
    },
    {
        "task_id": "test_user_3",
        "prompt": "Забронировать билеты на самолет до 15 декабря для поездки в Санкт-Петербург"
    },
]
...
def send_test_messages():
    try:
        ...
        for i, message in enumerate(TEST_MESSAGES):
            ...
            logger.info(
                f"Message {i + 1} sent | task_id={message['task_id']} | "
